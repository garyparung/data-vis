...
d3.csv('network.csv', function(data_heroes){
    return {
        hero_1: data_heroes.hero1,
        hero_2: data_heroes.hero2
    };
}).then(data_heroes => {
    data_network = data_heroes
...
function drawAnimation(){
    ...
    let hero_2 = [];
    let links_data = [];
    for (var i = 0, row; row = data_network[i]; i++) {
